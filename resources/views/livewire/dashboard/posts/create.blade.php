<div>
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-muted-foreground">Write and publish a new blog post for your website.</p>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="border border-border rounded-lg overflow-hidden">
                        <div class="bg-muted/30 px-4 py-2 border-b border-border">
                            <div class="flex items-center space-x-2">
                                <flux:button type="button" onclick="formatText('bold')" variant="ghost" size="xs" kbd="⌘+B">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-card border border-border rounded-lg p-6">
                    ...
                    <!-- Published Status -->
                    <flux:checkbox wire:model.live="is_published" label="Publish immediately" class="mb-4" />

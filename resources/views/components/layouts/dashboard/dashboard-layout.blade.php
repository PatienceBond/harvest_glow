...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <flux:sidebar sticky collapsible class="bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700">
        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.item icon="book-open" href="{{ route('dashboard.publications.index') }}" :current="request()->routeIs('dashboard.publications.*')">Publications</flux:sidebar.item>
